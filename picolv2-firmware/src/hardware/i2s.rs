...
///
/// Ported unchanged from oxynth-and-embassy/oxynth (src/i2s_ping_pong.rs) -
/// this is generic I2S/PIO/DMA plumbing, not tied to any particular synth.
...
// This local driver intentionally targets the current routing: PIO0 + SM0.
const PIO_NO: u8 = 0;
